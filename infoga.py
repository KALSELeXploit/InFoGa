...
def back():
    ...
    if back[0].upper() == 'Y':
        ...
        print('\033[92mRemember https://kalselexploit.blogspot.com')
        exit
    else:
        print('\033[92m?')
        exit
...
def bill():
   ...
   .-.  ,       `___:  ×=[CODENAME : IY×RafCode]=×
  (   ) :        ___   ×=[MY TEAM  : Kalsel[E]Xploit]=×
...
def banner():
 ...
 5) Port Scanner               17) Find Admin login site (useBreacher)
 6) Page Links                 18) Check and Bypass CloudFlare 
 7) Zone Transfer              19) Website Copier (use httrack)
 8) HTTP Header                20) Host Info Scanner (use WhatWeb)
 9) Host Finder                21) About InfoGa
...
def iseeverything():
    try:
        ...
        if choose == '1':
            ...
            print("""\033[93mInfoGa 2.1 - Information Gathering of a Website or IP address

AUTHOR: https://kalselexploit.blogspot.com
        https://t.me/KalselExploit""")
            back()
